...
import { IoCartSharp, IoPerson, IoSearch } from "react-icons/io5";
  ...
  return (
    <div className="container-fluid-lg">
      <div className="sticky">
          ...
          >
            <SwiperSlide>
              <div className="d-flex justify-content-center align-items-center mt-3">
                <p>
                  {" "}
                  Get Extra 10% Off on orders above $1000 using code: EXTRA10{" "}
                </p>
              </div>
            </SwiperSlide>
            <SwiperSlide>
        ...
        <div className="nav">
          {/* Ant Design Row and Col usage */}
          <div
            style={{ gap: "2vh", paddingRight: "20px", paddingLeft: "20px" }}
          ...
          >
            ...
            <div className="thirdcol">
              <div className="delivery">
                <span
                  style={{ fontSize: "10px", color: "#8C9096" }}
                  className="fw-bold"
                >
                  Delivery & Stores
                </span>
                <span
                  className="fw-bolder"
                  style={{ color: "#E88BED", fontSize: "10px" }}
                >
                  Enter Pincode
                </span>
              </div>
              <div className="delivery">
                <span>
                  <img
                    style={{ height: "16px", width: "30px", cursor: "pointer" }}
                    className="img-fluid"
                    src="\assests\images\flag\india-flag-free-vector.jpg"
                    alt=""
                  />
                </span>
              </div>
              <div className="delivery">
                <span>
                  <IoPerson style={{ color: "#4F3267", fontSize: "19px" }} />
                </span>
              </div>
              <div className="delivery">
                <span>
                  <FaHeart style={{ color: "#4F3267", fontSize: "19px" }} />
                </span>
              </div>
              <div className="delivery">
                <span>
                  <IoCartSharp style={{ color: "#4F3267", fontSize: "20px" }} />
                </span>
              </div>
            </div>
          </div>
